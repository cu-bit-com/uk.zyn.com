		...
		<div className={global.wrapper}>
			...
			<div className={styles.listWrapper}>	
				<ul className={styles.list}>
					<li className={styles.listItem}>Break the perforated label on the can.</li>
					<li className={styles.listItem}>Open it up and take out a nicotine pouch - popping it under your lip.</li>
					<li className={styles.listItem}>Leave the pouch in your mouth for between 5 and 10 minutes, or up to 30 minutes.</li>
					<li className={styles.listItem}>Discard the pouch in the waste compartment of the can once you’ve used it.</li>
				</ul>
			</div>
			<br/><br/>
