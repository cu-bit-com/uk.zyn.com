    ...
    return (
        <div className={`${styles.wrapper}`}>
            <ul className={styles.list}>
               ...
               <li className={styles.listItem}>
                <div className={styles.title} onClick={() => toggleCollapse(2)}><div className={styles.listTitle}>Does ZYN contain tobacco?</div><div className={styles.listTitle}>{signs[2]}</div></div>
               ...
               <li className={styles.listItem}>
                <div className={styles.title} onClick={() => toggleCollapse(4)}><div className={styles.listTitle}>How many pouches are in one can?</div><div className={styles.listTitle}>{signs[4]}</div></div>
               ...
               <li className={styles.listItem}>
                <div className={styles.title} onClick={() => toggleCollapse(5)}><div className={styles.listTitle}>Where is ZYN produced?</div><div className={styles.listTitle}>{signs[5]}</div></div>
               ...
               <li className={styles.listItem}>
                <div className={styles.title} onClick={() => toggleCollapse(6)}><div className={styles.listTitle}>Will ZYN help me quit smoking?</div><div className={styles.listTitle}>{signs[6]}</div></div>
			   ...
			   <li className={styles.listItem}>
                <div className={styles.title} onClick={() => toggleCollapse(9)}><div className={styles.listTitle}>What is the best way to store ZYN? </div><div className={styles.listTitle}>{signs[9]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(10)}><div className={styles.listTitle}>Why is there a lid on top of the can? What is it for?</div><div className={styles.listTitle}>{signs[10]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(11)}><div className={styles.listTitle}>Can I reuse ZYN nicotine pouches?</div><div className={styles.listTitle}>{signs[11]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(12)}><div className={styles.listTitle}>Is there any risk of using ZYN?</div><div className={styles.listTitle}>{signs[12]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(13)}><div className={styles.listTitle}>Can I use the product if I have gum disease?</div><div className={styles.listTitle}>{signs[13]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(14)}><div className={styles.listTitle}>What if I ingest/swallow ZYN?</div><div className={styles.listTitle}>{signs[14]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(15)}><div className={styles.listTitle}>How long does it take for the tingling/burning sensation to start and how long does it last?</div><div className={styles.listTitle}>{signs[15]}</div></div>
                ...
                <div className={styles.title} onClick={() => toggleCollapse(16)}><div className={styles.listTitle}>Can I recycle the can and what kind of plastic is it made of?</div><div className={styles.listTitle}>{signs[16]}</div></div>
               ...
               </li><li className={`${styles.listItem} ${styles.last}`}>
